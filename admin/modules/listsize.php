<div class="card">
  ...
  <div class="card-body">
    <table id="bootstrap-data-table" class="table table-striped table-bordered">
       ...
       <?php 
       $sqlSelect="SELECT*FROM tbl_size";
       ...
       while ($row= mysqli_fetch_assoc($result)) {
        ...
        <tr>
          ...
          <td>
               <a  onclick="return confirm('Bạn có muốn xóa không?');" href="index.php?view=deletesize&id=<?php echo $row["size_id"] ?>"> <img src="../uploads/icon_delete.jpg" width="25"><span>Delete</span></a>
...
<script>
  function deleleCat(id){
    ...
    if(check){
      window.location.assign("index.php?view=deletesize&id="+id);
    }
  }
</script>
