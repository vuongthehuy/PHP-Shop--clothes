    ...
    <div class="col-lg-6">
      <div class="card">
        <div class="card-header">
          <strong class="card-title">Thông tin size</strong>
        </div>
        <div class="card-body">
         <?php 
         if(isset($_POST["addNew"]))
         {
          ...
          $status=$_POST["status"];
          $sqlInsert="INSERT INTO tbl_size (size_name,`status`) VALUES('$size_name','$status')";
            ...
            <div class="card-body">
              <form action="" method="post" enctype="multipart/form-data">
                <div class="form-group">
                  <label for="cc-payment" class="control-label mb-1">Tên size</label>
                  <input id="size_name" name="size_name" type="text" class="form-control" aria-required="true" aria-invalid="false" value="">
                </div>
